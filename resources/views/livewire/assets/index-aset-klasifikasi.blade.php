<div>
                    ...
                    <div class="card">
                        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                ...
                                <h3 class="card-title">Setting Klasifikasi <i class="fa-solid fa-database"></i></h3>
                            </div>
                            <div style="display: flex; gap: 10px; margin-left: auto;">
                                ...
                                <button wire:click="$dispatch('openModalCreate', { component: 'modal.create-aset-klasifikasi' })" type="button" class="btn btn-primary">
                                ...
                                <tbody>
                                    @forelse ($klasifikasis as $klasifikasi)
                                        <tr wire:key="{{ $klasifikasi->id }}">
                                            ...
                                            <td><span>{{ $klasifikasi->updated_at->timezone('Asia/Makassar')->format('d M Y, H:i') }} WITA ({{ $klasifikasi->updated_at->diffForHumans() }})</span></td>
                                            <td>
                                                <div class="">
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.setting_attr.klasifikasi.show', ['id' => $klasifikasi->id]) }}" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i></a>
    ...
    {{-- Komponen Modal/CreateAsetKlasifikasi --}}
