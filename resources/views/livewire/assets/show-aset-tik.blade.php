            ...
            <div class="card-header">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item">
                            <a wire:click="switchSection('section-4')" href="{{ route('admin.asettik.show', ['id' => $id, 'section' => 'section-4']) }}" class="nav-link {{ $currentSection === 'section-4' ? 'active' : '' }}">
                                Files
                        ...
                        <li class="nav-item">
                            <a wire:click="switchSection('section-5')" href="{{ route('admin.asettik.show', ['id' => $id, 'section' => 'section-5']) }}" class="nav-link {{ $currentSection === 'section-5' ? 'active' : '' }}">
                                Time Log
