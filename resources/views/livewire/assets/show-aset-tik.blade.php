            ...
            <div class="card-header">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item">
                            <a wire:click="switchSection('penjadwalan')" href="{{ route('admin.asettik.show', ['id' => $id, 'section' => 'penjadwalan']) }}" class="nav-link {{ $currentSection === 'penjadwalan' ? 'active' : '' }}">
                                Penjadwalan
                        ...
                        <li class="nav-item">
                            <a wire:click="switchSection('issues')" href="{{ route('admin.asettik.show', ['id' => $id, 'section' => 'issues']) }}" class="nav-link {{ $currentSection === 'issues' ? 'active' : '' }}">
                                Penugasan
                        ...
                        <li class="nav-item">
                            <a wire:click="switchSection('section-3')" href="{{ route('admin.asettik.show', ['id' => $id, 'section' => 'section-3']) }}" class="nav-link {{ $currentSection === 'section-3' ? 'active' : '' }}">
                                Tickets
                        ...
                        <li class="nav-item">
                            <a wire:click="switchSection('files')" href="{{ route('admin.asettik.show', ['id' => $id, 'section' => 'files']) }}" class="nav-link {{ $currentSection === 'files' ? 'active' : '' }}">
                                Files
                        ...
                        <li class="nav-item">
                            <a wire:click="switchSection('timelog')" href="{{ route('admin.asettik.show', ['id' => $id, 'section' => 'timelog']) }}" class="nav-link {{ $currentSection === 'timelog' ? 'active' : '' }}">
                                Time Log
