<div>
                    ...
                    <div class="card">
                        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                ...
                                <h3 class="card-title">Setting Label <i class="fa-solid fa-database"></i></h3>
                            </div>
                            <div style="display: flex; gap: 10px; margin-left: auto;">
                                ...
                                <button wire:click="$dispatch('openModalCreate', { component: 'modal.create-aset-label' })" type="button" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover table-responsive-md">
                                ...
                                <tbody>
                                    @forelse ($klasifikasis as $label)
                                        <tr wire:key="{{ $label->id }}">
                                            <td>
                                                {{ $loop->iteration }}
                                            </td>
                                            <td>
                                            ...
                                            <td><span>{{ $label->updated_at->timezone('Asia/Makassar')->format('d M Y, H:i') }} WITA ({{ $label->updated_at->diffForHumans() }})</span></td>
                                            <td>
                                                <div class="">
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.setting_attr.label.show', ['id' => $label->id]) }}" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i></a>
    ...
    @livewire('modal.create-aset-label')
</div>
