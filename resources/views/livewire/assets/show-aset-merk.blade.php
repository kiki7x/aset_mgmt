<div class="container-md">
    <section class="content-header">
        <div class="d-flex justify-content-between mb-1">
            <h3>Nama Merk {{ $name }}</h3>
            <a href="{{ route('admin.setting_attr.merk') }}" type="button" class="btn btn-primary">
            ...
            <div class="card-header">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a wire:click="switchSection('')" href="{{ route('admin.setting_attr.merk.show', ['id' => $id, 'section' => '']) }}" class="nav-link {{ $currentSection === '' ? 'active' : '' }}">
                                Summary
