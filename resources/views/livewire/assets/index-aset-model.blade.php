<div>
                    ...
                    <div class="card">
                        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                ...
                                <h3 class="card-title">Setting Model <i class="fa-solid fa-database"></i></h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover table-responsive-md">
                                ...
                                <tbody>
                                    @forelse ($klasifikasis as $model)
                                        <tr wire:key="{{ $model->id }}">
                                            <td>
                                                {{ $loop->iteration }}
                                            </td>
                                            <td>
                                            ...
                                            <td><span>{{ $model->updated_at->timezone('Asia/Makassar')->format('d M Y, H:i') }} WITA ({{ $model->updated_at->diffForHumans() }})</span></td>
                                            <td>
                                                <div class="">
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.setting_attr.model.show', ['id' => $model->id]) }}" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li><a href="{{ route('admin.setting_attr.model.edit', ['id' => $model->id]) . '/edit' }}"><i class="fa fa-trash-o fa-fw"></i>Edit</a></li>
                                                                <li><a href="" wire:click="$dispatch('openModalDelete', { id: {{ $model->id }} })" onclick="event.preventDefault()"><i class="fa fa-trash-o fa-fw"></i>Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    @livewire('modal.create-aset-model')
</div>
