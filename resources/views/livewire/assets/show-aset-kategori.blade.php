<div class="container-md">
    <section class="content-header">
        <div class="d-flex justify-content-between mb-1">
            <h3>Nama Kategori {{ $name }}</h3>
            <a href="{{ route('admin.setting_attr.kategori') }}" type="button" class="btn btn-primary">
            ...
            <div class="card-header">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a wire:click="switchSection('')" href="{{ route('admin.setting_attr.kategori.show', ['id' => $id, 'section' => '']) }}" class="nav-link {{ $currentSection === '' ? 'active' : '' }}">
                                Summary
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="card col-md-4">
                                    ...
                                    <table class="table table-hover table-responsive">
                                        <tbody>
                                            <tr>
                                                <td><strong>Nama Klasifikasi</strong></td>
                                                <td>:</td>
                                                <td>{{ $asset->name }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>{{ $asset->classification->name ?? 'N/A' }}</td>
                                            </tr>
                                            <tr>
