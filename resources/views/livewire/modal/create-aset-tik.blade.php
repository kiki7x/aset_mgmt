                    ...
                    <div class="row form-group">
                        ...
                        <div class="form-group col-md-4">
                            <div x-data="{
                                ...
                                <select wire:model="form.model" x-ref="select2model" name="model" id="model" class="form-control select2tag @error('form.model') is-invalid @enderror" for="model" multiple="multiple">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input wire:model="form.serial" name="serial" type="text" class="form-control @error('form.serial') is-invalid @enderror" id="serial" placeholder="SN harus unik/tidak boleh sama dengan yang lain">
                            @error('form.serial')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
