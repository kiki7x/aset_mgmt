                ...
                <div class="modal-body">
                    <div class="row form-group">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input wire:model="form.client_id" type="text" name="client_id" class="form-control @error('form.client_id') is-invalid @enderror" id="client_id" placeholder="client_id">
