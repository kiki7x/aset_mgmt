                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Master Data Merk/Pabrikan <i class="fa-solid fa-database"></i></h3>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover table-responsive-md">
                                ...
                                <tbody>
                                    @forelse ($merks as $merk)
                                        <tr wire:key="{{ $merk->id }}">
                                            <td>
                                                <a href="{{ route('admin.asettik.show', ['id' => $merk->id]) }}">{{ $merk->id }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.asettik.show', ['id' => $merk->id]) }}" class="font-weight-bold">{{ $merk->name }}</a>
                                            </td>
                                            <td><span>{{ $merk->updated_at }}</span></td>
                                            <td>
                                                <div class="">
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.asettik.show', ['id' => $merk->id]) }}" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                                        {{-- <a href="" onclick="event.preventDefault()" wire:click="edit({{ $merk->id }})" class="btn btn-flat btn-success btn-sm"><i class="fa fa-edit"></i></a> --}}
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li><a href="{{ route('admin.asettik.show', ['id' => $merk->id]) . '/edit' }}"><i class="fa fa-trash-o fa-fw"></i>Edit</a></li>
                            ...
                            <div class="row">
                                <!-- Pagination -->
                                <div class="col-md-12">
                                    {{-- {{ $merks->links('vendor.livewire.bootstrap') }} --}}
                                </div>
                                <div class="col-md-12">
