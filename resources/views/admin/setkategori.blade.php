                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Master Data Kategori <i class="fa-solid fa-database"></i></h3>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover table-responsive-md">
                                ...
                                <tbody>
                                    @forelse ($kategoris as $kat)
                                        <tr wire:key="{{ $kat->id }}">
                                            <td>
                                                <a href="{{ route('admin.asettik.show', ['id' => $kat->id]) }}">{{ $kat->id }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.asettik.show', ['id' => $kat->id]) }}" class="font-weight-bold">{{ $kat->name }}</a>
                                            </td>
                                            <td><span>{{ $kat->updated_at }}</span></td>
                                            <td>
                                                <div class="">
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.asettik.show', ['id' => $kat->id]) }}" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                                        {{-- <a href="" onclick="event.preventDefault()" wire:click="edit({{ $kat->id }})" class="btn btn-flat btn-success btn-sm"><i class="fa fa-edit"></i></a> --}}
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li><a href="{{ route('admin.asettik.show', ['id' => $kat->id]) . '/edit' }}"><i class="fa fa-trash-o fa-fw"></i>Edit</a></li>
                                                                <li><a href="" wire:click="$dispatch('openModalDelete', { id: {{ $kat->id }} })" onclick="event.preventDefault()"><i class="fa fa-trash-o fa-fw"></i>Delete</a></li>
                            ...
                            <div class="row">
                                <!-- Pagination -->
                                <div class="col-md-12">
                                    {{-- {{ $kategoris->links('vendor.livewire.bootstrap') }} --}}
                                </div>
                                <div class="col-md-12">
