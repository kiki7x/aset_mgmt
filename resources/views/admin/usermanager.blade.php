...
@section('script-foot')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Jika Anda ingin tombol filter manual, Anda bisa menghapus script di atas
            // dan hanya mengandalkan tombol "Filter" bawaan form.
            // Contoh:
            // $('#filterForm').on('submit', function(e) {
            //     // Anda bisa menambahkan validasi atau modifikasi data di sini sebelum submit
            // });
        });
    </script>
@endsection
