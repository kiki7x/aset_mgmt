...
class IndexAsetMerk extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.assets.index-aset-merk')->with([
        'klasifikasis' => ManufacturersModel::search($this->search)
    ...
    try {
        $category = ManufacturersModel::find($this->deleteId);
