...
class IndexAsetLokasi extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.assets.index-aset-lokasi')->with([
            'klasifikasis' => LocationsModel::search($this->search)
    ...
    public function delete($id)
    {
        ...
        try {
            $category = LocationsModel::find($this->deleteId);
