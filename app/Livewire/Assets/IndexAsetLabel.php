...
class IndexAsetLabel extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.assets.index-aset-label')->with([
            'klasifikasis' => LabelsModel::search($this->search)
    ...
    public function delete($id)
    {
        ...
        try {
            $category = LabelsModel::find($this->deleteId);
